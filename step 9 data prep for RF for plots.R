...
collared_animals <- read_csv("W:/VF/Optimising_VF/Chiswick/data_prep/step8_all_animals_collars.csv")
...
dist_bewteen <- read_csv("W:/VF/Optimising_VF/Chiswick/data_prep/step7_count_close_animals.csv")



## make a new variable hours
dist_bewteen$time_step <- as.POSIXct(dist_bewteen$time_step,  tz = "Australia/Sydney")
...
output_path <- "W:/VF/Optimising_VF/Chiswick/data_prep/"  
