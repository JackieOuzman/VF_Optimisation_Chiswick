...
GPS_Dist <- read_csv("W:/VF/Optimising_VF/Chiswick/data_prep/step4_dist_line_VF_zone.csv")
names(GPS_Dist)
...
start <- min(GPS_Dist$local_time, na.rm = TRUE)  # "2022-06-28 09:56:30 ACDT"
end <-   max(GPS_Dist$local_time, na.rm = TRUE) # "2022-07-02 10:06:32 ACDT"
...
write.csv(regular_time_interval, "W:/VF/Optimising_VF/Chiswick/data_prep/reg_time_step_max_min.csv", row.names = FALSE)
