...
GPS_Sheep <- read_csv("W:/VF/Optimising_VF/Chiswick/data_prep/step5_all.csv")
 
GPS_Sheep$local_time <- as.POSIXct(GPS_Sheep$local_time,  tz = "Australia/Sydney")          
GPS_Sheep$time_step <- as.POSIXct(GPS_Sheep$time_step,  tz = "Australia/Sydney") 
...
list_of_comparsions <- read_excel("W:/VF/Optimising_VF/Chiswick/data_prep/list of animal comparisons.xlsx", 
...
write.csv(df, "W:/VF/Optimising_VF/Chiswick/data_prep/step6_dist_between_animals_matrix.csv")
