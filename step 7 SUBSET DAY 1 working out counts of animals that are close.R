...
matrix <- read_csv("W:/VF/Optimising_VF/Chiswick/data_prep/step6_dist_between_animals_matrix.csv") 
...
reg_time_step <- reg_time_step %>%  filter(date == "2022-06-28")#day 12022-06-28
...
write.csv(df, "W:/VF/Optimising_VF/Chiswick/data_prep/step7_count_close_animals.csv", row.names = FALSE)
